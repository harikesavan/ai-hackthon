...
export const FacilityDetailPanel = ({
  ...
  const panelClasses = isDarkMode
    ? "absolute left-4 top-24 z-[900] w-[360px] rounded-2xl border border-white/10 bg-slate-900/80 p-5 text-sm text-slate-200 shadow-2xl backdrop-blur-xl"
    : "absolute left-4 top-24 z-[900] w-[360px] rounded-2xl border border-slate-200/50 bg-white/80 p-5 text-sm text-slate-700 shadow-2xl backdrop-blur-xl";
